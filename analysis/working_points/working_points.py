...
from analysis.working_points.utils import get_ctag_mask, get_ctag_mask_2d
...
class WorkingPoints:
    ...
    def jet_ctagging_2d(self, events, wp, year):
        return get_ctag_mask_2d(events.Jet, year, wp)